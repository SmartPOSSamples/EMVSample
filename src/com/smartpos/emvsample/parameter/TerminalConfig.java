package com.smartpos.emvsample.parameter;
...
public class TerminalConfig 
{
	...
	private final String DEFAULT_COUNTRY_CODE = "0156";
	private final String DEFAULT_TERMINAL_TYPE = "22";
	private final String DEFAULT_TERMINAL_CAPABILITY = "E0F8C8"; // ""E0F0C8";
	private final String DEFAULT_ADDITIONAL_TERMINAL_CAPABILITY = "FF80F0A001"; // "FF80F0A001";
	...
	private final int    DEFAULT_CONTACTLESS_LIMIT = 100000;
	private final int    DEFAULT_CONTACTLESS_FLOOR_LIMIT = 100000;
    private final int    DEFAULT_CONTACTLESS_CVM_LIMIT = 1000;
    ...
    public void loadTerminalConfig()
    {
    	...
    	ecLimit = terminalPref.getInt(ecLimitTag, 0);
    	contactlessLimit = terminalPref.getInt(contactlessLimitTag, DEFAULT_CONTACTLESS_LIMIT);
    	contactlessFloorLimit = terminalPref.getInt(contactlessFloorLimitTag, DEFAULT_CONTACTLESS_FLOOR_LIMIT);
    	cvmLimit = terminalPref.getInt(cvmLimitTag, DEFAULT_CONTACTLESS_CVM_LIMIT);
    }
