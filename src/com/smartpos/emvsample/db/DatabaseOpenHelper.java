    ...
    public final static String CREATE_AID_SQL = 
    		"Create table if not exists " + TABLE_AID  + " ( _id"                        + " integer primary key autoincrement," +
    				"                                        aid"                        + " varchar(16)," +
														   ...
														   " termRiskManageData"         + " varchar(8)," +
														   " contactlessLimit"           + " integer," +
    		                                               " contactlessFloorLimit"      + " integer," +
    		                                               " cvmLimit"                   + " integer," +
														   " c2KernelConfig"             + " char(1)," +
														   " c2ctlOnDeviceCVM"           + " long," +
														   " c2CtlNoOnDeviceCVM"         + " long," +
														   " c2CvmCapCVMRequired"        + " char(1)," +
														   " c2CvmCapNoCVMRequired"      + " char(1)," +
														   " c2MscvmCapCVMRequired"      + " char(1)," +
														   " c2MscvmCapNoCVMRequired"    + " char(1)," +
				                                           " contactlessKernelID"        + " char(1));";
